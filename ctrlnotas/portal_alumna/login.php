...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["loginbtn"])) {
    $login = new Login($db);
    if($login->access()) {
         header("location:".SITE_URL."portal_alumna/index.php");
    }else{
...
<html lang="en">
    <head>
        <title><?php echo TITLE_SITE_ALU; ?> - Inicio de Session</title>
        <meta charset="utf-8">
        ...
        <header id="top">
            <div class="container_12 clearfix">
                <div id="logo" class="grid_12">
                    ...
                    <a id="site-title" href="<?php echo SITE_URL;?>portal_alumna/login.php"><span><?php echo TITLE_SITE_ALU . '</span> ' . COMPANY ; ?></a>
                </div>
            </div>
        </header>
