        ...
        <header id="top">
            <div class="container_12 clearfix">
                <div id="logo" class="grid_5">
                    ...
                    <a id="" href="<?php echo SITE_URL;?>portal_docente/index.php"><?php echo  COMPANY ; ?></a>
                </div>
                ...
                <div id="userinfo">  <!--class="grid_3" removido user info-->
			Bienvenido, <a href="#"><?php echo  $_SESSION['sys_docente_nom'];?></a>
                </div>
            </div>
        </header>
            ...
            <div class="container_12 clearfix">
                <div class="grid_12">
                    <ul id="mainmenu" class="sf-menu">
                        <li class="<?php $main_cur =($sub=="inde")?'current':''; echo $main_cur;?>"><a href="<?php echo SITE_URL;?>portal_docente/index.php">Inicio</a></li>
                        <li class="<?php $main_cur =($sub=="modu")?'current':''; echo $main_cur;?>"><a href="<?php echo SITE_URL;?>portal_docente/add_notas.php">Notas</a></li>
