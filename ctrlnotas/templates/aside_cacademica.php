<aside id="sidebar" class="grid_3 pull_9">
    ...
    <div class="box menu">
        ...
        <section>
            <ul>
                <li><a href="cacad.php">Inicio</a></li>
                <li><a href="cacad_add.php">Registar</a></li>
                <li><a href="cacad_list.php">Listado General</a></li>
                <li><a href="cacad_list.php?list=docente&token=<?php echo md5('list');?>">Listado por Docente</a></li>
